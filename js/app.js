...
$(document).ready(diagramResponsive);
$(window).on('resize',diagramResponsive);

function diagramResponsive() {
...
// change tabs to dropdown on mobile
$('#course-vert-tabs').on('change.zf.tabs', function() {
  $('.title-bar').foundation('toggleMenu');

  // allow accessible tabbing on mobile dropdown
  $(".no-jump").attr('tabindex', '0');
});
...
$(document).ready(function(){
  ...
  $("#sitewrap a").not('.no-jump').on('click', function(event) {
